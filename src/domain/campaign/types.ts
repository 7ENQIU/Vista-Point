export const CAMPAIGN_SCHEMA_VERSION = 5 as const
...
export const LOGIC_GROUP_OPERATORS = ['all', 'any', 'none'] as const
...
export const LOGIC_CONDITION_FIELDS = ['state', 'lifecycle_status'] as const
...
export const LOGIC_EXECUTION_MODES = ['require_confirmation', 'suggest_only'] as const
