...
- Версия проекта: `0.1.2`. Ранее опубликованный web-prerelease `v0.1.0` сохранён неизменным; первая desktop-база — `v0.1.1`, цель end-to-end обновления — `v0.1.2`.
...
- Локально собраны подписанные NSIS и `.sig` для desktop-базы `0.1.1`; после подготовки `0.1.2` их копии и контрольные суммы находятся только в игнорируемом `src-tauri/target/updater-test/`.
